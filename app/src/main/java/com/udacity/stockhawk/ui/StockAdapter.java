...
class StockAdapter extends RecyclerView.Adapter<StockAdapter.StockViewHolder> {
    ...
    public void onBindViewHolder(StockViewHolder holder, int position) {
        ...
        holder.price.setText(FormatHelper.formatDollar(mCursor.getFloat(Contract.Quote.POSITION_PRICE)));
        ...
        String change = FormatHelper.formatSignedDollar(rawAbsoluteChange);
        String percentage = FormatHelper.formatRelativeChange(percentageChange);
